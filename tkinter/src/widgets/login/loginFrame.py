...
class LoginFrame(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.label_title = ctk.CTkLabel(self,text='Inicio de Sesión',fg_color="transparent",font=ctk.CTkFont(size=25,weight='bold'),text_color=color.TEXT)
        self.label_title.grid(row=1, column=0, padx=15, pady=(15,0), sticky="we")

        self.label_username = ctk.CTkLabel(self,text='Usuario:',fg_color="transparent",font=ctk.CTkFont(size=16),text_color=color.TEXT)
        self.label_username.grid(row=2, column=0, padx=15, pady=(30,0), sticky="w")

        self.entry_username = ctk.CTkEntry(self, placeholder_text="Usuario",fg_color="transparent", width=350, height=40, font=ctk.CTkFont(size=14), border_width=1,text_color=color.TEXT)
        self.entry_username.grid(row=3, column=0, padx=15, pady=(0,10), sticky="w")

        self.label_password = ctk.CTkLabel(self,text='Contraseña:',fg_color="transparent",font=ctk.CTkFont(size=16),text_color=color.TEXT)
        self.label_password.grid(row=4, column=0, padx=15, pady=(10,0), sticky="w")

        self.entry_password = ctk.CTkEntry(self, placeholder_text="Contraseña",fg_color="transparent", width=350, height=40, font=ctk.CTkFont(size=14) ,show="*", border_width=1,text_color=color.TEXT)
        self.entry_password.grid(row=5, column=0, padx=15, pady=(0,10), sticky="w")

        self.label_response = ctk.CTkLabel(self,text="", height=40, fg_color="transparent",font=ctk.CTkFont(size=16),text_color=color.TEXT)
